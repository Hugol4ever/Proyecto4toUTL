    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div class="login-form">
                ...
                <hr>
                <br>
                <form name="registro" action="Controladores/Actualizar.jsp" method="POST">
                    <div class="form-group ">
                        Tipo de Pan: <select name="nombre" class="form-control">

                            <%
                                PanesLista pl = new PanesLista();
                                ArrayList<Panes> lista = pl.nombre();
                                for (Panes ls : lista) {
                            %>
                            <option value ="<%= ls.getCodPan()%>"><%= ls.getDescripcion()%></option>
                            <%
                                }
                            %>
                        </select>
                        Numero de panes : <input type="text" class="form-control" name="existencia"><br>
