...
insert into Usuario (Nom_Usuario,Contraseña,Id_Huella1) values (var_Nom_Usuario,var_Contraseña,var_Id_Huella);
set var_Id_Usuario = last_insert_id();

insert into Cliente (Nombre,Correo,Telefono,Genero,N_Tarjeta,Id_Usuario1) values (var_Nombre,var_Correo,var_Telefono,var_Genero,var_N_Tarjeta,var_Id_Usuario);
...
select Id_Cliente, Nombre, Huella from Cliente c inner join Usuario u on c.Id_Usuario1 = u.Id_Usuario inner join Huella h on u.Id_Huella1 = h.Id_Huella;
